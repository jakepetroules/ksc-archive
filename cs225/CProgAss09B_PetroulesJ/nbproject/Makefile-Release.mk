...
${OBJECTDIR}/EmpAcademicRecord.o: EmpAcademicRecord.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EmpAcademicRecord.o EmpAcademicRecord.cpp

${OBJECTDIR}/EmpExtraCurricular.o: EmpExtraCurricular.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EmpExtraCurricular.o EmpExtraCurricular.cpp
...
${OBJECTDIR}/EmpEmploymentHistory.o: EmpEmploymentHistory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EmpEmploymentHistory.o EmpEmploymentHistory.cpp

${OBJECTDIR}/EmpPersonalInfo.o: EmpPersonalInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EmpPersonalInfo.o EmpPersonalInfo.cpp
...
${OBJECTDIR}/CollegeMain.o: CollegeMain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CollegeMain.o CollegeMain.cpp

${OBJECTDIR}/EmpPublicationLog.o: EmpPublicationLog.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/EmpPublicationLog.o EmpPublicationLog.cpp
