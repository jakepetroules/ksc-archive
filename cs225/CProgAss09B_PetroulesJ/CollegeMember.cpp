...
string CollegeMember::toString() const
{
    stringstream stream;
    stream << "ID: " << this->m_id << endl;
    stream << "First name: " << this->m_firstName << endl;
    stream << "Last name: " << this->m_lastName << endl;
    stream << "Address line 1: " << this->m_address1 << endl;
    stream << "Address line 2: " << this->m_address2 << endl;
    stream << "State: " << this->m_state << endl;
    stream << "ZIP: " << this->m_zip << endl;
    stream << "Telephone: " << this->m_telephone << endl;
    stream << "Email: " << this->m_email << endl;
    return stream.str();
}
