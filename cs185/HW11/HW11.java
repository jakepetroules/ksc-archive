...
public class HW11
{
	public static void main(String[] args) throws IOException
	{
		...
		Scanner scan = new Scanner(new File("HW11in.txt"));
		FileOutputStream out = new FileOutputStream("HW11out.txt");
		PrintWriter writer = new PrintWriter(out);
		writer.println("Linked List Program Report - CS185-1 - HW11\n");
		writer.println(list);
