...
public class ClinicMonitor
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.println("> reassign - Move all patients from one doctor to another");
    ...
    public void reassign(BufferedReader reader) throws IOException
    {
        String doctorFromName = InputHelper.getString(reader, "Enter the name of the doctor to reassign the patients from: ");
        DoctorQueue doctorFrom = this.findDoctor(doctorFromName);
        if (doctorFrom != null)
        {
            String doctorToName = InputHelper.getString(reader, "Enter the name of the target doctor: ");
            ...
            if (doctorTo != null)
            {
                if (doctorTo.isAvailable())
                {
                    ...
                    {
                        doctorTo.add(doctorFrom.remove());
                    }
                }
                else
                {
                    System.out.println("Dr." + doctorTo.getName() + " is not available right now.");
                }
            }
            else
            {
