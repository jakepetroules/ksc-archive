...
Public Class MainForm
    ...
    Private Function CalculateTotal() As Decimal
        ...
        Dim weeklyUnitPrice As Decimal
        If Me.studioRadioButton.Checked Then
        ...
        If Me.linenServiceCheckBox.Checked Then
            totalCost += 20 * rentalPeriod.Days * If(Me.penthouseRadioButton.Checked, 4, 1)
        End If
    ...
    Private Sub generateReceiptButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles generateReceiptButton.Click
