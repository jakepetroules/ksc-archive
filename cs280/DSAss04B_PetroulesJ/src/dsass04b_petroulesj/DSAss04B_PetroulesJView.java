/*
 * DSAss04B_PetroulesJView.java
 */

package dsass04b_petroulesj;
 ...
 */
public class DSAss04B_PetroulesJView extends FrameView implements TableModelListener
{
    public DSAss04B_PetroulesJView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DSAss04B_PetroulesJApp.getApplication().getMainFrame();
            aboutBox = new DSAss04B_PetroulesJAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DSAss04B_PetroulesJApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(dsass04b_petroulesj.DSAss04B_PetroulesJApp.class).getContext().getResourceMap(DSAss04B_PetroulesJView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(dsass04b_petroulesj.DSAss04B_PetroulesJApp.class).getContext().getActionMap(DSAss04B_PetroulesJView.class, this);
