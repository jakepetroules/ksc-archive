 ...
 */
public class DSAss02_PetroulesJView extends FrameView implements TableModelListener
{
    public DSAss02_PetroulesJView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DSAss02_PetroulesJApp.getApplication().getMainFrame();
            aboutBox = new DSAss02_PetroulesJAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DSAss02_PetroulesJApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(dsass02_petroulesj.DSAss02_PetroulesJApp.class).getContext().getResourceMap(DSAss02_PetroulesJView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(dsass02_petroulesj.DSAss02_PetroulesJApp.class).getContext().getActionMap(DSAss02_PetroulesJView.class, this);
