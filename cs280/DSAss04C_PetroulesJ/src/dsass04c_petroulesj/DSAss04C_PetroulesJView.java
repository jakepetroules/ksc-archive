/*
 * DSAss04C_PetroulesJView.java
 */

package dsass04c_petroulesj;
 ...
 */
public class DSAss04C_PetroulesJView extends FrameView implements TableModelListener
{
    public DSAss04C_PetroulesJView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DSAss04C_PetroulesJApp.getApplication().getMainFrame();
            aboutBox = new DSAss04C_PetroulesJAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DSAss04C_PetroulesJApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(dsass04c_petroulesj.DSAss04C_PetroulesJApp.class).getContext().getResourceMap(DSAss04C_PetroulesJView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(dsass04c_petroulesj.DSAss04C_PetroulesJApp.class).getContext().getActionMap(DSAss04C_PetroulesJView.class, this);
