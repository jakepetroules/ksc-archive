...
public final class GridFormatter
{
    ...
    /**
     * Initializes a new instance of the {@link GridFormatter} class with the specified number of
     * columns.
     * @param columns the number of columns in the table
     * @exception IllegalArgumentException if the number of columns is less than 1
     */
    ...
    public String toString()
    {
        ...
        for (int i = 0; i < this.getColumnCount(); i++)
        {
            Object currentHeader = this.getHeader()[i];
            if (this.isUpperCaseHeaders())
            {
                currentHeader = currentHeader.toString().toUpperCase();
            }
