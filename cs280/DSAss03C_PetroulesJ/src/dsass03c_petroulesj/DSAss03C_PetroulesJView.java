 ...
 */
public class DSAss03C_PetroulesJView extends FrameView implements TableModelListener
{
    public DSAss03C_PetroulesJView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DSAss03C_PetroulesJApp.getApplication().getMainFrame();
            aboutBox = new DSAss03C_PetroulesJAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DSAss03C_PetroulesJApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(dsass03c_petroulesj.DSAss03C_PetroulesJApp.class).getContext().getResourceMap(DSAss03C_PetroulesJView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(dsass03c_petroulesj.DSAss03C_PetroulesJApp.class).getContext().getActionMap(DSAss03C_PetroulesJView.class, this);
