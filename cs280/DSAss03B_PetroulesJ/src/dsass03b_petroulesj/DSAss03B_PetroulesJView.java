 ...
 */
public class DSAss03B_PetroulesJView extends FrameView implements TableModelListener
{
    public DSAss03B_PetroulesJView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = DSAss03B_PetroulesJApp.getApplication().getMainFrame();
            aboutBox = new DSAss03B_PetroulesJAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        DSAss03B_PetroulesJApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(dsass03b_petroulesj.DSAss03B_PetroulesJApp.class).getContext().getResourceMap(DSAss03B_PetroulesJView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(dsass03b_petroulesj.DSAss03B_PetroulesJApp.class).getContext().getActionMap(DSAss03B_PetroulesJView.class, this);
